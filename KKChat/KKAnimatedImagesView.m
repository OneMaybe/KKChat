...
@interface KKAnimatedImagesView()
{
    BOOL animating;
...
@implementation KKAnimatedImagesView
...
- (NSTimeInterval)timePerImage
{
    if (_timePerImage == 0)
    {
        return KKAnimatedImagesViewDefaultTimePerImage;
    }
    
    return _timePerImage;
}

- (void)setDelegate:(id<KKAnimatedImagesViewDelegate>)delegate
{
